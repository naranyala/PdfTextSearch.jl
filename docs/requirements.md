...
The attached blueprint defines `pdfprobe` as a private, local-first Julia CLI whose north-star result is a trustworthy answer to “where does this phrase occur?” with enough evidence to verify it.
