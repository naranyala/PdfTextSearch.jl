...
This documentation describes the current release in this repository. It states the external tools required and the capabilities that remain on the roadmap.
...
For planned work, see [TODOS.md](../TODOS.md), which separates the implemented workflow from pending hardening, parser, indexing, OCR, and packaging work.
